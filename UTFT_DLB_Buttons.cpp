...
int UTFT_DLB_Buttons::addButton(uint16_t x, uint16_t y, uint16_t width, uint16_t height, bitmapdatatype data, uint16_t flags)
{
    int btcnt = UTFT_Buttons::addButton(x, y, width, height, data, flags);
...
void UTFT_DLB_Buttons::drawButtons()
{
	for (int i=0;i<MAX_BUTTONS;i++)
	{
